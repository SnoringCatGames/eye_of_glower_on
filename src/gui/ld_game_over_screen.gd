...
const LOSE_MESSAGE := \
        "Oh no, the forces of good have prevailed!"
const WIN_MESSAGE := \
        "Your power is preserved, and the world will bend to your will!!"
...
func _ready() -> void:
    ...
    $VBoxContainer/WinLoseMessage.text = \
            WIN_MESSAGE if \
            Sc.level_session.has_finished else \
            LOSE_MESSAGE
...
func _update_stats() -> void:
    ...
    was_best_playthrough_label.visible = false
    
    was_fastest_playthrough_label.visible = false
